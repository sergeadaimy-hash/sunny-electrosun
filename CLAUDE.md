...
| `MODEL_CLASSIFIER`, `MODEL_REPLY`, `MODEL_TEACHER`, `MODEL_OWNER_QA` | Override the model per call site. All set to `claude-sonnet-4-6` on Railway (2026-07-06 revert), matching the code defaults. |
